    ...
    <footer
      ...
      <main class="rounded-b-2xl pb6 my4 gap1 flex flex-col justify-center items-center md:(border-t-2 w-3xl mt-8)">
        ...
        <p xmlns:cc="http://creativecommons.org/ns#" xmlns:dct="http://purl.org/dc/terms/">
          <a property="dct:title" rel="cc:attributionURL" href="https://blog.racca.me">Seba's Blog</a>
          by
          <a rel="cc:attributionURL dct:creator" property="cc:attributionName" href="https://racca.me">
