import { d as y, w as m } from './singletons.af1bc4ce.js';
const P = '' + new URL('../assets/avatar.9d2117a3.png', import.meta.url).href,
  L = [
    '' + new URL('../assets/avatar.f6a08045.avif', import.meta.url).href,
    '' + new URL('../assets/avatar.ec2b368f.webp', import.meta.url).href,
  ],
  k = '' + new URL('../assets/avatar.3288fe50.jpeg', import.meta.url).href,
  R = '' + new URL('../assets/avatar.2149bba4.jpeg', import.meta.url).href,
  A = '' + new URL('../assets/avatar.fa6b069e.jpeg', import.meta.url).href,
  O = '' + new URL('../assets/avatar.df189fa7.jpeg', import.meta.url).href,
  S = '' + new URL('../assets/cover.ed3357af.webp', import.meta.url).href,
  b = {
  ...
  q = { me: ['https://github.com/SebaOfficial'], custom: ({ dev: e }) => (e ? [] : []) },
  Q = {
    toPublishedString: {
      locales: 'en-US',
      options: { year: 'numeric', weekday: 'short', month: 'short', day: 'numeric', timeZone: `${b.timeZone}` },
    },
    toUpdatedString: {
      locales: 'en-US',
      options: { year: 'numeric', weekday: 'short', month: 'short', day: 'numeric', timeZone: `${b.timeZone}` },
...
var h = () =>
  ...
  G = (e) =>
    Object.fromEntries(
      u(e)
        ...
        .map((t) => t.split(':'))
        .reduce(
          (t, a) => (a.length === 2 ? [...t, a.map((s) => s.trim())] : ((t[t.length - 1][1] += ',' + a[0]), t)),
          [],
        ),
    ),
  g = /(\{(?:[^{}]+|\{(?:[^{}]+)*\})*\})/g,
  ...
  T = (e, t = !0, a = '', s = '') =>
    e
      .split(g)
      .map((r) => {
        if (!r.match(g)) return r;
        const n = u(r);
        if (n.startsWith('{')) return I(u(n), s);
        const o = E(n);
        return (s = o.k || s), !a && (a = s), o;
      })
      .map((r) => {
  ...
  B = (e, t, a) =>
    t.reduce((s, r) => {
      var n;
      return (r.match(z) ? ((o) => o[s] ?? o['*'])(G(r)) : (n = e[r]) == null ? void 0 : n.call(e, s)) ?? s;
    }, a),
  x = (e, { z: t, o: a, t: s, f: r, m: n, r: o }, i) => {
    ...
    e
      .map((r) => {
        ...
        const { k: n = '0', f: o = [] } = r,
          i = s[n];
        return U(r)
          ? ((typeof i == 'boolean' ? (i ? r.o : r.r) : x(t, r, i)) || '').replace(F, i)
          : ('' + ((o.length ? B(a, o, i) : i) ?? '')).trim();
      })
      .join(''),
  D = (e, t, a, s) => {
    const r = s[0],
      n = r && typeof r == 'object' && r.constructor === Object,
      o = s.length === 1 && n ? r : s;
    return N(e, t, a, o);
  },
  V = (e, t) => e[t] || (e[t] = T(t)),
...
var p = (e = {}, t) =>
  ...
  v = (e, t) =>
    new Proxy(p(e, t), {
      get: (a, s) =>
        s === Symbol.iterator ? [][Symbol.iterator].bind(Object.values(a).map((r) => p(r, t))) : v(a[s], t),
    }),
  W = (e, t = {}) => {
    const a = m(),
      s = m(h()),
