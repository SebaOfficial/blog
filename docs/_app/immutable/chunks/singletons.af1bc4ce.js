...
var g;
const w = ((g = globalThis.__sveltekit_q0y4fs) == null ? void 0 : g.base) ?? '';
var k;
const y = ((k = globalThis.__sveltekit_q0y4fs) == null ? void 0 : k.assets) ?? w,
  E = '1701630570159',
...
function A() {
  ...
  async function o() {
    clearTimeout(n);
    try {
      const r = await fetch(`${y}/_app/version.json`, { headers: { pragma: 'no-cache', 'cache-control': 'no-cache' } });
      if (!r.ok) return !1;
...
const Y = { url: h({}), page: h({}), navigating: d(null), updated: A() };
export {
  O as I,
  p as P,
  x as S,
