            ...
            if (scriptContent) {
              if (isScriptJsType(scriptType)) {
                ...
                const loadOnMainThread =
                  scriptId &&
                  (null ===
                    (_b = null === (_a = config.loadScriptsOnMainThread) || void 0 === _a ? void 0 : _a.includes) ||
                  void 0 === _b
                    ? void 0
                    : _b.call(_a, scriptId));
                if (loadOnMainThread) {
          ...
          commaSplit('atob,btoa,crypto,indexedDB,setTimeout,setInterval,clearTimeout,clearInterval').map(
            (globalName) => {
              ...
              if (!(globalName in win)) {
                ...
                null != value &&
                  (win[globalName] =
                    'function' != typeof value || value.toString().startsWith('class') ? value : value.bind(self));
              }
            },
          );
            ...
            try {
              ...
              if (rsp.ok) {
                ...
                let shouldExecute = javascriptContentTypes.some((ct) => {
                  ...
                  return null ===
                    (_c =
                      null === (_a = null == responseContentType ? void 0 : responseContentType.toLowerCase) ||
                      void 0 === _a
                        ? void 0
